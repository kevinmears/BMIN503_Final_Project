...
covid.month.fit <- glm(COVID ~ factor(DISCHARGE_MONTH), data = covid_binary_month, family = binomial)
...
-   No change in sex preference with COVID for bacterial pneumonia and enterococcus.

-   Bacterial pneumonia had a similar seasonality as COVID-19 and was significantly associated with COVID-19 infection.

-   Limitations of the study are the lack of accessibility of the pre-pandemic (2019) and post-pandemic data sets. For example, a study by the CDC found that the incidence of central-line bloodstream infections, catheter-associated UTIs, ventilator-associated infections, and MRSA bacteremia was significantly higher in 2021 than pre-pandemic levels (Lastinger et al. 2022).
